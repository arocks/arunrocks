...
module Jekyll
  ...
  class SitemapGenerator < Generator
    ...
    #BASE_URL = 'http://www.arunrocks.com'
    ...
    def generate_content(site)
      ...
      site.pages.each{ |page|
        ...
        mod_date = File.mtime(site.source + path)
  			...
  			# Remove the trailing 'markdown' extension and just output the folder name.
  			if path=~/.markdown$/
  			  path = path[0..-10] + '/'
  		    end

  			# Remove the trailing 'html' extension and just output the folder name.
  			if path=~/.html$/
  			  path = path[0..-6] + '/'
  		    end
